...
//    public static final TenantId SYSTEM_TENANT = TenantId.fromUUID(ModelConstants.NULL_UUID);
     ...
     * Generic constants.
     */
    public static final String BARC_SCHEMA = "barc";
    public static final String ID_PROPERTY = "id";
    public static final String CREATED_TIME_PROPERTY = "created_time";
    public static final String UPDATED_TIME_PROPERTY = "updated_time";
    public static final String VALID_FROM_TIME_PROPERTY = "valid_from";
    public static final String VALID_TO_TIME_PROPERTY = "valid_to";
    public static final String STATUS_ID_VALID_FROM_TIME_PROPERTY = "status_id_valid_from";
    public static final String STATUS_ID_VALID_TO_TIME_PROPERTY = "status_id_valid_to";
    public static final String PROFILE_ID_VALID_FROM_TIME_PROPERTY = "profile_id_valid_from";
    public static final String PROFILE_ID_VALID_TO_TIME_PROPERTY = "profile_id_valid_to";
    public static final String MEMBER_ID_VALID_FROM_TIME_PROPERTY = "member_id_valid_from";
    public static final String MEMBER_ID_VALID_TO_TIME_PROPERTY = "member_id_valid_to";
    public static final String UPDATED_BY_PROPERTY = "updated_by";
    ...
    public static final String IS_ACTIVE_PROPERTY = "is_active";
    public static final String REMARK = "remark";
    public static final String EVENT_TYPE = "event_type";
    public static final String METER_EVENT_TS = "meter_event_ts";
    ...
    public static final String BM2 = "BM2";
    public static final String BM3 = "BM3";
    public static final String BM4 = "BM4";
    /**
     * User constants.
     */
    public static final String USER_PG_HIBERNATE_TABLE_NAME = "tb_user";
    public static final String USER_ROLE_HIBERNATE_TABLE_NAME = "user_role";
    ...
    public static final String USER_USERNAME_PROPERTY = "user_name";
    ...
    public static final String USER_PROFILE_STATUS_PROPERTY = "profile_status";
    public static final String USER_PROFILE_TYPE_PROPERTY = "profile_type";
    public static final String USER_TYPE_PROPERTY = "type";
    public static final String USER_COMPANY_PROPERTY = "company";
    public static final String USER_DEPARTMENT_PROPERTY = "department";
    public static final String USER_DESIGNATION_PROPERTY = "designation";
    public static final String USER_SERIAL_NUMBER_PROPERTY = "serial_number";
    public static final String USER_MAX_RECORD_PER_PAGE_PROPERTY = "max_record_per_page";
    public static final String USER_HOUSE_HOLD_TYPE = "household_type";
    ...
    public static final String USER_AUTH_SETTINGS_TWO_FA_SETTINGS_FACTOR_AUTHENTICATION = "two_fa_settings_required";
    public static final String USER_AUTH_SETTINGS_UI_ACCESS_REQUIRED = "ui_access_required";

    /**
     * HouseHold constants.
     */
    public static final String HOUSE_HOLD_TABLE_NAME = "household";
    ...
    public static final String IS_ACTIVE_TV = "is_active_tv";
    public static final String IS_ACTIVE_MEMBER = "is_active_member";
    public static final String HOUSEHOLD_STATUS = "HOUSEHOLD_STATUS";
    public static final String ACCEPTED = "ACCEPTED";
    public static final String HOUSE_HOLD_LOG_TABLE_NAME = "household_log";
    public static final String HOUSEHOLD_ID_PROPERTY = "household_id";

    /**
     * Remote constants.
     */

    public static final String REMOTE_TABLE_NAME = "remote";
    public static final String REMOTE_HISTORY_TABLE_NAME = "remote_history";
    public static final String REMOTE_REVIEW_TABLE_NAME = "remote_review";
    public static final String REMOTE_ID = "remote_id";
    public static final String REMOTE_SERIAL_NO = "remote_serial_no";
    public static final String REMOTE_SW_VERSION = "sw_version";
    public static final String REMOTE_PCB_SERIAL = "pcb_serial";
    public static final String REMOTE_BLE_ADDRESS = "ble_address";
    public static final String REMOTE_UPDATE_FROM = "update_from";
    public static final String REMOTE_UPDATE_TO = "update_to";
    public static final String REMOTE_PRODUCTION_DATE = "production_date";
    public static final String REMOTE_STATUS_ID = "status_id";
    /**
    ...
    /**
     * UserProfileImage constants.
     */

    public static final String USER_PROFILE_IMAGE_UPLOAD_TABLE_NAME = "user_profile_image";
    ...
    public static final String IMEI_NUMBER_1 = "imei_number_1";
    public static final String IMEI_NUMBER_2 = "imei_number_2";
    public static final String BIOS_VERSION = "bios_version";
    public static final String NETWORK_OPERATOR = "network_operator";
    public static final String ASSET_SERIAL_NUMBER = "asset_serial_number";
    ...
    public static final String SDCARD_PARTNO = "sdcard_partno";
    public static final String SDCARD_SERIAL = "sdcard_serial";
    public static final String MOTHERBOARD_VERSION = "motherboard_version";
    public static final String DEVICE_SERIAL_NUMBER = "device_serial_number";
    public static final String SIM1_IMSI_ID = "sim1_imsi_id";
    public static final String SIM2_IMSI_ID = "sim2_imsi_id";
    public static final String MB_SERIAL = "mb_serial";
    public static final String MB_VERSION = "mb_version";
    public static final String LAST_EVENT_ID = "last_event_id";
    public static final String AUDIO_SOURCE_TS = "audio_source_ts";
    public static final String AUDIO_SOURCE_STATUS = "audio_source_status";

    public static final String DEVICE_INFO_VIEW_TABLE_NAME = "device_info_view";

    public static final String METER_HISTORY_TABLE_NAME = "meter_history";

    /**
     * Sim Data constants.
     */
    public static final String SIM_DATA_TABLE_NAME = "sim_data";
    ...
    /**
     * Meter profile constants.
     */
    public static final String DAYS = "days";
    /**
     * Meter profile constants.
     */
    public static final String MOTHERBOARD_SERIAL_NO = "motherboard_s_no";
    public static final String IMEI_BASEBOARD_SERIAL_NO = "imei_baseboard_s_no";
    public static final String POWER_PCB_SERIAL_NO = "powerpcb_s_no";
    ...
    public static final String K_LICENCE_KEY = "k_licence_key";
    public static final String AUTH_CODE = "auth_code";
    public static final String DEVICE_ID = "device_id";
    public static final String OTA_COMMIT_HASH = "ota_commit_hash";
    public static final String STATUS_ID = "status_id";
    public static final String OS_TYPE_ID = "os_type_id";
    public static final String K_LICENCE_NO = "k_licence_no";
    /**
    ...
    /**
     * Asset Installation constants.
     */
    public static final String ASSET_INSTALLATION_DATA_TABLE_NAME = "asset_installation_data";
    public static final String TV_ID = "tv_id";
    public static final String FIELD_MODE = "field_mode";
    public static final String FIELD_MODE_DATA = "FIELD_MODE";
    public static final String METER_INSTALLATION_STATUS_ID = "meter_installation_status_id";
    public static final String REMOTE_INSTALLATION_STATUS_ID = "remote_installation_status_id";
    public static final String REMOTE_REMARK = "remote_remark";
    public static final String METER_REMARK = "meter_remark";
    public static final String M_INSTALLATION_ACTIVE_FROM = "m_installation_active_from";
    public static final String M_INSTALLATION_ACTIVE_TO = "m_installation_active_to";
    public static final String R_PAIRING_ACTIVE_FROM = "r_pairing_active_from";
    public static final String R_PAIRING_ACTIVE_TO = "r_pairing_active_to";
    public static final String OLD_METER_ID = "old_meter_id";
    public static final String IS_CONFIG = "is_config";
    public static final String NEW_METER_ID = "new_meter_id";
     ...
     * Technical  constants.
     */
    public static final String TECHNICAL_CONFIG_TABLE_NAME = "technical_config";
    ...
    public static final String USER_MODULE_ID_PROPERTY = "module_id";
    public static final String PARENT_PROPERTY = "parent";

    public static final String ORDER_NUMBER = "order_number";

    public static final String ROLE_TABLE_NAME = "role";
    public static final String USER_ROLE_DESCRIPTION_PROPERTY = "description";
    public static final String USER_ROLE_PERMISSION_TABLE_NAME = "role_permission";
    ...
    public static final String RAW_METER_EVENT = "raw_meter_event_new";
    ...
    /**
     * Pre Processing Files constants.
     */
    public static final String PRE_PROCESSING_FILE_TABLE_NAME = "pre_processing_file";
     ...
     * Status constants.
     */
    public static final String META_DATA_TABLE_NAME = "meta_data";
    public static final String META_DATA_ID = "meta_data_id";

    /* Meter Conflict  constant*/
    public static final String METER_CONFLICT_TABLE = "meter_conflict";
    public static final String TEST_METER_ID = "test_meter_id";
    public static final String CONFLICT_METER_ID = "conflict_meter_id";
    public static final String CONFLICT_COMPONENT = "conflict_component";
    public static final String CONFLICTED_VALUE = "value";

    /**
     * System Settings constants.
     */

    public static final String SYSTEM_SETTINGS_TABLE_NAME = "system_setting";
    public static final String SESSION_TIMEOUT_CONFIGURATION = "session_timeout_configuration";
    public static final String MAX_SESSION_VALIDITY = "max_session_validity";
    public static final String INSTALL_READY_EVENT_TIMEOUT = "install_ready_event_timeout";
    public static final String MAX_PASSWORD_VALIDITY = "max_password_validity";
    public static final String MAX_PASSWORD_VALIDITY_ALERT_MESSAGE = "max_password_validity_alert_message";
    public static final String ORGANIZATION_NAME = "organization_name";
    public static final String REPORT_STATUS_MAIL = "report_status_mail";
    public static final String METER_CONFIG_ENVIRONMENT = "meter_config_environment";
    public static final String METER_CONFIG_START_SERIES = "meter_config_start_series";
    public static final String METER_CONFIG_END_SERIES = "meter_config_end_series";
    public static final String REMOTE_CONFIG_START_SERIES = "remote_config_start_series";
    public static final String REMOTE_CONFIG_END_SERIES = " remote_config_end_series";
    public static final String REMOTE_CONFIG_OS_TYPE_ID = "remote_config_osTypeId";
    public static final String METER_CONFIG_DATE_RANGE_START = "meter_config_date_range_start";
    public static final String METER_CONFIG_DATE_RANGE_END = "meter_config_date_range_end";
    public static final String REMOTE_CONFIG_DATE_RANGE_START = "remote_config_date_range_start";
    public static final String REMOTE_CONFIG_DATE_RANGE_END = "remote_config_date_range_end";


    /**
     * List Management.
     */
    public static final String LISTMANAGEMENT_TABLE_NAME = "manage_list";
    public static final String LIST_TYPE = "list_type";
    public static final String LIST_NAME = "list_name";
    public static final String LIST = "list";

    /**
     * Meter Test Report constants.
     */
    public static final String METER_TEST_REPORT_TABLE_NAME = "rpt_meter_test";
    public static final String TESTED_BY = "test_by";
    public static final String SIM1_REPORT = "sim1_report";
    public static final String SIM2_REPORT = "sim2_report";
    public static final String RTC_VOLT = "rtc_volt";
    public static final String TEST_DATE = "test_date";
    public static final String METER_TEST_STATUS = "METER_TEST_STATUS";
    public static final String SIM_PROVIDER = "SIM_PROVIDER";

    /**
     * OS Details constants.
     */
    public static final String OS_DATA = "os_data";
    public static final String OS_TYPE = "os_type";
    public static final String HARDWARE_VERSION = "hardware_version";
    public static final String CONFLICTED_COMPONENTS = "conflicted_components";
    public static final String MANDATORY_PARAMS = "mandatory_params";
    public static final String BMA_1_0_VERSION = "BMa-1.0";
    public static final String BMA_SET_VERSION = "BMa-SET";

    /**
     * Raw Meter Events Report constants.
     */
    public static final String RPT_RAW_METER_EVENT = "rpt_raw_meter_event";
    ...
    public static final String AUDIENCE_SESSION_FROM = "audience_session_from";
    public static final String AUDIENCE_SESSION_TO = "audience_session_to";
    public static final String REPORT = "report";

    /**
     * OTA Meter.
     */
    public static final String METER_OTA_DATA_TABLE_NAME = "meter_ota_data";
    public static final String OTA_SUMMARY_TABLE_NAME = "ota_summary";
    public static final String OS_BRANCH = "os_branch";
    public static final String OS_VERSION = "os_version";
    public static final String PUSH_SUCCESS = "push_success";
    public static final String PUSH_ERRORED = "push_errored";
    public static final String PUSHED_BY = "pushed_by";
    public static final String UPDATED_BY = "updated_by";
    public static final String PUSHED_ON = "pushed_on";
    public static final String APPLIED_ON = "applied_on";
    public static final String COMPATIBLE_HW_VERSION = "compatible_hw_version";
    public static final String RELEASE_NOTE_SUMMARY = "release_note_summary";
    public static final String RELEASE_DATE = "release_date";
    public static final String SUBMITTED_ON = "submitted_on";
    public static final String CANCELLED_ON = "cancelled_on";
    public static final String OTA_SUMMARY_ID = "ota_summary_id";

    /**
     *
     */
    public static final String METER_OTA_HISTORY_TABLE_NAME = "meter_ota_history";
    public static final String APPLIED_SW_VERSION = "applied_sw_version";
    public static final String PUSHED_SW_VERSION = "pushed_sw_version";

    /**
     * Intab constants.
     */
    public static final String INTAB_TABLE_NAME = "intab";
    public static final String INTAB_VALUE = "intab_value";
    ...
    /**
     * Meter Config constants.
     */
    public static final String METER_CONFIG = "meter_config";

    public static final String TECHNICAL_CONFIG_ID = "technical_config_id";

    public static final String APPLIED_VALUE = "applied_value";

    public static final String SERVER_VALUE = "server_value";

    public static final String IS_RE_SYNC = "is_re_sync";

    public static final String SUBMISSION_AT = "submission_at";

    public static final String APPLIED_AT = "applied_at";

    /**
     * WMK ID channel name constants
     */
    public static final String WMK_ID_CHANNEL_NAME = "wmk_id_channel_name";
    public static final String WMK_ID = "wmk_id";
    public static final String CHANNEL_CODE = "channel_code";
    public static final String CHANNEL_NAME = "channel_name";

    public static final String WMK_ID_CHANNEL_NAME_FILE_DATA = "wmk_id_channel_name_mapping_data";
    public static final String LAST_DEPRECATED_BY = "last_deprecated_by";
    public static final String AUDIENCE_SESSION = "audience_session";
    public static final String PRE_PROCESSING_FILE_ID = "pre_processing_file_id";

    public static final String LIVE_MONITORING_LOCATION_TABLE_NAME = "live_monitoring_location";
    ...
    public static final String INSTALLED_LOCATION_LATITUDE = "installed_location_latitude";
    public static final String INSTALLED_LOCATION_LONGITUDE = "installed_location_longitude";
